...
Hi there!
Thanks for taking an interest in improving nf-core/genomeassembler.

This page describes the recommended nf-core way to contribute to both nf-core/genomeassembler and nf-core pipelines in general, including:

- [General contribution guidelines](#general-contribution-guidelines): common procedures or guides across all nf-core pipelines.
- [Pipeline-specific contribution guidelines](#pipeline-specific-contribution-guidelines): procedures or guides specific to the development conventions of nf-core/genomeassembler.

> [!NOTE]
> If you need help using or modifying nf-core/genomeassembler, ask on the nf-core Slack [#genomeassembler](https://nfcore.slack.com/channels/genomeassembler) channel ([join our Slack here](https://nf-co.re/join/slack)).
...
- [ ] Check whether a GitHub [issue](https://github.com/nf-core/genomeassembler/issues) about your idea already exists. If an issue does not exist, create one so that others are aware you are working on it.
- [ ] [Fork](https://help.github.com/en/github/getting-started-with-github/fork-a-repo) the [nf-core/genomeassembler repository](https://github.com/nf-core/genomeassembler) to your GitHub account.
...
For further information and help, see the [nf-core/genomeassembler documentation](https://nf-co.re/genomeassembler/usage) or ask on the nf-core [#genomeassembler](https://nfcore.slack.com/channels/genomeassembler) Slack channel ([join our Slack here](https://nf-co.re/join/slack)).

### GitHub Codespaces

You can contribute to nf-core/genomeassembler without installing a local development environment on your machine by using [GitHub Codespaces](https://github.com/codespaces).
...
To get started, open the repository in [Codespaces](https://github.com/nf-core/genomeassembler/codespaces).
...
nf-core semi-standardises how you write code and other contributions to make the nf-core/genomeassembler code and processing logic more understandable for new contributors and to ensure quality.
